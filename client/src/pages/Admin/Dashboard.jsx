...
import { useGetAdminDashboardDataQuery } from '../../redux/api/dashboardAPI';
...
function Dashboard() {
    const { data: dashboardData, isLoading: isDashboardLoading } = useGetAdminDashboardDataQuery();
    ...
    const appointmentsByDateChartData = {
        labels: last30dates.map((date) => dayjs(date).format('DD-MMM')),
        datasets: [
            {
                fill: true,
                label: 'Appointments',
    ...
    return (
        ...
        >
            <Row gutter={[16, 16]}>
                ...
                <Col span={6}>
                    <Card bordered={false} title="Avegrage Appointments Per Day">
                        <Statistic
                            style={{
                                textAlign: 'center',
                                fontWeight: 'bold',
                ...
                <Col span={6}>
                    <Card bordered={false} title="Total Doctors">
                        <Statistic
                            style={{
                                textAlign: 'center',
                                fontWeight: 'bold',
                            }}
                            value={dashboardData?.totalApprovedDoctors}
                            prefix={<NumberOutlined />}
                        />
                    </Card>
                </Col>
